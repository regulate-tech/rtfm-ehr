...
def create_clinic_check_composition(systolic_value, diastolic_value):
    ...
    composition = {
        "_type": "COMPOSITION",
        "name": {"_type": "DV_TEXT", "value": "Clinic Check for BP"},
        ...
        "composer": {"_type": "PARTY_IDENTIFIED", "name": "Data Entry User"},
        "context": {
...
def create_hba1c_composition(hba1c_value):
    ...
    composition = {
        "_type": "COMPOSITION",
        "name": {"_type": "DV_TEXT", "value": "Lab Test Results"},
        ...
        "language": {"code_string": "en", "terminology_id": {"value": "ISO_639-1"}},
        "territory": {"code_string": "GB", "terminology_id": {"value": "ISO_3166-1"}},
        "composer": {"_type": "PARTY_IDENTIFIED", "name": "Automated Lab System"},
        "context": {
            "start_time": {"value": current_time_iso},
            "setting": {
                "defining_code": {
                                ...
                                "items": [
                                    {
                                        ...
                                        "value": {"_type": "DV_TEXT", "value": "HbA1c"},
                                    },
                                    {
                                        "_type": "CLUSTER",
    ...
    if form.validate_on_submit():
        ...
        if ehr_id is False:
            return render_template(
                "data_entry/search_data_entry.html", title="Find Patient EHR", form=form
            )
        elif ehr_id is None:
            ...
            return redirect(
                url_for("data_entry.dashboard", ehr_id=ehr_id, nhs_number=nhs)
            )
            ...
            if success:
                ...
                steps_list = [
                    [
                        "You",
                        "EHR Manager",
                        "1. You send data to the EHR via an API...",
                        "request",
                    ],
                    [
                        "EHR Manager",
                        "EHR Database",
                        "2. EHR Manager checks and sends data to the Database...",
                        "request",
                    ],
                    [
                        "EHR Manager",
                        "EHR Database",
                        "3. Database tells the EHR Manager it has saved the data...",
                        "response",
                    ],
                    [
                        "You",
                        "EHR Manager",
                        "4. EHR Manager sends you a confirmation code...",
                        "response",
                    ],
                ]
                ...
                redirect_url = url_for(
                    "data_entry.dashboard", ehr_id=ehr_id, nhs_number=nhs_number
                )
    ...
    if form.validate_on_submit():
        try:
            ...
            if success:
                ...
                final_msg = (
                    f"Generated HbA1c result ({hba1c_val:.1f} mmol) for EHR {ehr_id}"
                )
                ...
                steps_list = [
                    [
                        "Laboratory",
                        "EHR Manager",
                        "1. Lab system sends data to the EHR Manager via its API...",
                        "request",
                    ],
                    [
                        "EHR Manager",
                        "EHR Database",
                        "2. EHR Manager checks and sends the record to the database... ",
                        "request",
                    ],
                    [
                        "Laboratory",
                        "EHR Manager",
                        "3. EHR Manager confirms the save to the Lab system...",
                        "response",
                    ],
                ]
                anim_data = json.dumps(steps_list)
